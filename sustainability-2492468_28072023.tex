...
Our results are relevant for \hl{the }analysis of geotechnical properties of soil since they provide new information about the strength parameters of soil stabilised with various water-binder mixtures. Adjusted proportions of binders allow us to focus on soil hardening through the stabilisation workflow with optimised water-binder ratio. We \hl{furthermore }demonstrated \hl{that} the water-binder ratio is \hl{an }important factor in s/s \hl{soil }treatment techniques aimed at improving \hl{the initially }poor engineering properties of dredged marine sediments prior to reuse \hl{as construction materials}. 
