...
Under the framework of the presented modelling of stabilised soil properties, it was shown that various w/b dosage provides essential information at the variable feature level for modelling \hl{the }dependency of soil strength on \hl{a }binder content. Besides, \hl{the }improved binder properties enhance key characteristics of \hl{the }construction materials, such as compressive, tensile and shear strength, ductility and flexure \cite{Reddy2022,Maheretal2008,MaherHo1994}. Finally, the optimal combination of \hl{the }w/b ratio are obtained for dredged clayey sediments in \hl{a} laboratory scale which can be generalised at the \hl{large-scale }project level. The proposed modelling of soil properties at a laboratory scale minimises the costs of \hl{the }project-run works where large quantities of sediments must be dredged repeatedly for the needs of marine transportation. \hl{In view of the above said, }the contributions of the this paper are threefold:
