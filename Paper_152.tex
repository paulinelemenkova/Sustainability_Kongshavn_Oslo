...
The uniaxial compressive strength tests (UCS) were carried out according to the existinf Swedish standard SS-EN 16907-4 with a recommended deformation rate of 1 mm/min for specimens with a height of 100 mm. For the point $1\_2$, the vbt = 5, 6 and 7 were tested. As the ratio between water and binder controls the strength, samples with vbt = 5 had higher strength compared to samples with vbt = 6 or 7, which proved as expected results. Table \ref{tab01} shows the respective vbt (water/binder ratio) and compressive strength of the specimens.

\begin{table}[H] 
\caption{Compressive strength for specimens from the sample test point No.  $1\_2$.\label{tab01}}
\begin{tabularx}{\textwidth}{CCC}
\toprule
\textbf{Sample No} & \textbf{vbt} & \textbf{UCS (kPa)}\\
\midrule
$1\_1$ & 5 & 829\\
$1\_2$ & 5 & 833\\
$1\_3$ & 5 & 853\\
...
The specimens within the same vbt, e.g. $1\_1$ to $1\_4$ show a small variation in strength values. The same applies to the other vbt. Test sampels No. $1\_1$ and test body $1\_2$, however, exhibit a different stiffness compared to the other test samples. Such a variation in stiffness is normal and is due to the natural variations in the inner individual properties of soil material. Table \ref{tab02} shows the results of the testing of specimens from the sampling point No. 3. Specifically, it is showing the compressive strength and water/binder ratio for specimens.

\begin{table}[H] 
\caption{Compressive strength for specimens from the sample test point No. 3.\label{tab02}}
\begin{tabularx}{\textwidth}{CCC}
\toprule
\textbf{Sample No} & \textbf{vbt} & \textbf{UCS (kPa)}\\
\midrule
