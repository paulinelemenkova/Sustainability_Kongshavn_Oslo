...
\begin{table}[H] 
\caption{Table 9. Table showing compressive strength for specimens.\label{tab01}}
...
\end{adjustwidth}
\caption{Correlation between the pressure (kPa) and relative deformation of the samples. \label{fig06}}
\end{figure}
