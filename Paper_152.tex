...
Table \ref{tab03} shows the values of the compressive strength and w/b for specimens collected in various test sites (TS). 
...
The specimens within the same w/b, for instance, ID No. $1\_1$ to $1\_4$, show smaller variation in strength values. The same applies to the other w/b ratios. Test samples No. $1\_1$ and test body $1\_2$, however, shows a different stiffness compared to other samples. Such a variation in stiffness is normal and is explained by the natural individual parameters of soil masses. The results of the tests on the compressive strength and water/binder ratio for specimens collected from the sampling point No. 3 are also shown in the same Table \ref{tab03}. Specimen $4\_4$ from TS 4 obtained a significantly higher strength compared to the others with the same w/b and should therefore be considered as an outlier.
...
\begin{table}[H] 
\caption{Analysis of the concentration of heavy metals, PAH and TBT (mg/kg).\label{tab05}}
...
\begin{table}[H] 
\caption{Analysis of the concentration of PCBs (mg/kg).\label{tab06}}
